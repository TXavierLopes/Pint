            ...
            <div class="col-xs-12">
                <div class="box">
                        ...
                        <table id="table" class="table table-striped table-bordered nowrap" >
                            ...
                            <?php foreach($boleias as $boleia)  {  ?>
                                <tr>
                                    ...
                                    <td> <a  class="btn btn-default" href="<?php echo base_url() . "index.php/Membro_controller/detalhesboleia/" .  $boleia->id_boleia ?>">Inscrever na boleia</a></td>
                                </tr>
                            <?php }?>
                        </table>
                        <!-- /.box-body -->
                    ...
                    <script>
                        function myFunction() {
                            // Declare variables
                            var input, filter, table , tbody, tr, th, td, i;
