            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <br>
                        <h3 class="box-title">Boleias Inscritas</h3>
                    </div>
                        ...
                        <table id="table" class="table table-striped table-bordered nowrap" >
                            ...
                            <?php foreach($boleias as $boleia)  {  ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-default" style="margin: auto;" href="unsubscribe_ride/<?= $boleia->id_boleia?>">Cancelar</a></td>
                                </tr>
                            <?php }?>
                        </table>
